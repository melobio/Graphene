...
from batch import BatchFinetune, BatchMasking, BatchAE, BatchSubstructContext, BatchNodeMasking
...
class DataLoaderMasking(torch.utils.data.DataLoader):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=True, **kwargs):
        super(DataLoaderMasking, self).__init__(
            ...
            batch_size,
            shuffle,
            collate_fn=lambda data_list:  BatchNodeMasking.from_data_list(data_list),
            **kwargs)
